...
\section{Introduction}
        ...
        \subsection{A Brief Introduction to Origami and Kirigami}
            ...
            \paragraph{}
            Origami is the art of folding paper. One of its earliest depictions was the folding of an ancient Egyptian map made from papyrus. Upon the invention of paper, paper folding was used mainly in religious ceremonies due its high price. There are examples of paper folding across many cultures therefore it is difficult to say where and when it was invented. % \cite{origami bible stuff} 
            
            After folding paper became popular, cutting followed. Cutting paper is also transcends across many cultures. Scherenschnitte is the German and Swiss art of cutting paper which produces intricate silhouettes. %https://www.nytimes.com/2016/11/27/fashion/craft-scherenschnitt-switzerland.html
            ...
            . Florence Temko evolved the word to become "kirigami" in 1962 who's book "Kirigami, the Creative Art of Papercutting" became so popular that the word became synonymous with cutting paper. %\cite{https://www.origami-resource-center.com/kirigami.html..
          ...
          https://www.kyuhoshi.com/2014/11/kirigami/
           ...
           The famous magician Harry Houdini describes many origami and kirigami designs in his book Paper Magic. Such as folding a square piece of paper and making a five pointed star with a single cut. % /citebook.
           ...
           Today kirigami is used as a recreational activities and commonly across all cultures at Christmas to make snowflakes.
            ...
            \subsubsection{Relevance}
                ...
                and Alexandra Verschueren won the L'Oréal Professional Grand Prize at the Hyères International Festival of Fashion and Photography with her unique innovative designs inspried by kirigami.  %https://www.vogue.it/en/talents/graduated-from/2010/04/alexandra-verschueren?refresh_ce=#ad-image9229
                
                Nahoko Kojima is a kirigami artist who has had her collections displayed in numerous locations worldwide most recetly in the Dulwich Picture Gallery in London featuring a 8.5m crocodile. %http://www.nahokokojima.com/galleries-overview/
                Kanako Yaguchi is another artist that will have her 2019 kirigami exhibition displayed in Tokyo %http://www.yorokobinokatachi.com/2019ex/index.html
                
                In addition, Marc Hagan-Guirey is a paper artist who gained popularity with the creation of the Star Wars kirigami book which displays how to create models inspired by the movie. %http://www.paperdandy.co.uk/star-war-kirigami-book
...
\subsection{Requirements}
    ...
    \begin{enumerate}
      \item Home Screen
        ...
        \item The application must allow the users to select a "create Pattern" button or a "Match pattern" button linkin3g them to eh relevant screen
      ...
      \end{enumerate}
       \item Choose Fold
        \begin{enumerate}[label*=\arabic*.]
        \item The application must allow the user to choose whether they want the virtual piece of paper folded into 2,4,6 or 8 pieces.
      \end{enumerate}
      \item Creating cuts
      \begin{enumerate}[label*=\arabic*.]
        \item The application must display the corresponding shape of the folded piece of paper depending on which fold was selected.
        ...
        \item The application must indicate to the user where the start of their cut.
        \item The application must allow the user to complete their cut by tapping near the start of their cut. 
      \end{enumerate}
      \item Create Pattern
        \begin{enumerate}[label*=\arabic*.]
        \item The application must display a folded
      \end{enumerate}
      \item Match Pattern
        \begin{enumerate}[label*=\arabic*.]
        \item 
      ...
      \item Reveal
        \begin{enumerate}[label*=\arabic*.]
        \item The application must show the user an unfolded version of their cuts from the corresponding folded virtual peice of paper. 
    ...
    Performance
    The application should respond to the users touch within 0.5 seconds.
    The application should take no longer than 5 seconds to load up after it has been downloaded onto the iPhone.
    Useability
        The average user should be familiar with the application after 5 minutes of use. 
        The average user should be able to understand the flow of app easily.
        
        Supportability
        The application shall be available on iPhone 7,8 ..check
        
        Dependability
        The application shall be availabl
        
        The application shall be updated to the latest version 
        ...
        Maintainability
Maintainability: This relates to the ease at which your app finds bugs and fixes t
...
\section{Human Computer Interaction}
    ...
    \subsection{Theme}
        ...
        \subsection{Additional Features}
            \paragraph{}
        The additional features of the application, while not crucial to the core function, are crucial to creating an overarching theme for the application creating a more complete and consistent experience for the user. Additional features include the icon, music player, information page etc are explained below. 
    ...
    \subsection{Publishing}
        ...
        I would need to test this on a greater variety of users to see if I have fully achieved what I aimed for with this application as it was mostly my peers.  I can publish the application as test version to get user feedback on websites such as TestFlight. %cite
