...
\section{Introduction}
        ...
        \subsection{A Brief Introduction to Origami and Kirigami}
            ...
            After folding paper became popular, cutting followed. Cutting paper also transcends across many cultures. Scherenschnitte is the German and Swiss art of cutting paper which produces intricate silhouettes. %https://www.nytimes.com/2016/11/27/fashion/craft-scherenschnitt-switzerland.html
          ...
          %https://www.kyuhoshi.com/2014/11/kirigami/
           ...
           Today kirigami is used as a recreational activities and commonly across all cultures at Christmas to make snowflakes.
            ...
            \subsubsection{Relevance}
                ...
                Nahoko Kojima is a kirigami artist who has had her collections displayed in numerous locations worldwide most recently in the Dulwich Picture Gallery in London featuring a 8.5m crocodile. %http://www.nahokokojima.com/galleries-overview/
...
\subsection{Requirements}
   ...
   \subsubsection{ Non-Functional}
    ...
    \paragraph{}
    I used the storyboard in Xcode to lay out the general overview of the application. This visualisation was handy when creating segues between the classes as I could see clearly which classes were interacting. The Navigation controller was used so the user will be familiar with the flow of the app quickly. \hfill
            \begin{wrapfigure}{l}{0.3\textwidth}
                        \centering
                        \includegraphics[width=0.25\textwidth]{KiriZen/createPattern.png}
                        \caption{createPattern}
